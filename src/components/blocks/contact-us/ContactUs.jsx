    ...
    <>
      <div className={styles.root}>
        <div className={styles.content}>
          ...
          >Let’s move your business forward to the clouds! Tell us about your idea! We will interview you and offer the
            best solution for reaching the goal.</Paragraph>
          <Button
            responsiveFull
            size="xl"
            onClick={ctx.open}
